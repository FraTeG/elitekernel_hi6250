...
static struct alucard_tuners {
	...
	.sampling_rate = ATOMIC_INIT(10000),
	.inc_cpu_load_at_min_freq = ATOMIC_INIT(1),
	.inc_cpu_load = ATOMIC_INIT(2),
	.dec_cpu_load_at_min_freq = ATOMIC_INIT(1),
	.dec_cpu_load = ATOMIC_INIT(2),
#ifdef CONFIG_CPU_EXYNOS4210
	.freq_responsiveness = ATOMIC_INIT(100000),
#else
	.freq_responsiveness = ATOMIC_INIT(208000),
#endif
